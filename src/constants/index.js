...
export const navLinks = [ABOUT_LINK, WORK_LINK, SKILLS_LINK, CERTIFICATES_LINK, CONTACT_LINK];
export const navDotsLinks = [HOME_LINK, ABOUT_LINK, WORK_LINK, SKILLS_LINK, CERTIFICATES_LINK, CONTACT_LINK];
